...
@app.route('/login')
async def login():
    redirect_uri = config.REDIRECT_URI #configten aldık
    scope = 'identify guilds' #botun guildleri okuyabilmesini istiyoruz
    discord_login_url = (
...
@app.route('/dashboard') #dashboard fonksiyonu
async def dashboard():
